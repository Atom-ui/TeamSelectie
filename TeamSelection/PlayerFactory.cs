...
namespace TeamSelectie
{
    public class PlayerFactory
    {
        ...
        {
            string line;
            using (StreamReader r = new StreamReader(@"C:\Users\davy\Documents\data\Voetbal\rodeDuivels.txt"))
            {
        ...
        public Player CreatePlayer(string value)
        {
            ...
            switch (collectie[0])
            {
                ...
                default: throw new ArgumentException($"Verkeerde Code Jonge! {value}");
            }
        }
